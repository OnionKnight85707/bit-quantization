...
import com.mzwise.unifyexchange.future.FutureTradingServiceFactory;

public class SpTradingTest {
...
//      下单
		...
		Order.Response response = FutureTradingServiceFactory.getInstance(Constants.EXCHANGE_NAME.BINANCE)
		.postUsdtOrder(order);
