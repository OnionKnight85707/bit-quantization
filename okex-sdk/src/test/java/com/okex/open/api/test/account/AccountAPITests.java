...
public class AccountAPITests extends  AccountAPIBaseTests {
    ...
    public void getAccountAndPosition(){
        JSONObject result = this.accountAPIService.getAccountAndPosition("");
    ...
    public void getBillsDetails7Days(){
        JSONObject result = this.accountAPIService.getBillsDetails7Days("SPOT","","","","","","","","");
        toResultString(LOG, "result", result);
    }
    ...
    public void getBillsDetails3Months(){
        JSONObject result = this.accountAPIService.getBillsDetails3Months("SPOT",null,null,null,"8",null,null,null,null);
        toResultString(LOG, "result", result);
    }
