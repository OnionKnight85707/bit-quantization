...
public class PublicDataAPITest extends PublicDataAPIBaseTest {
    ...
    public void getInstruments(){
        ...
        JSONObject symbol = (JSONObject) data.stream().filter(v -> ((JSONObject) v).getString("instId").equals("BTC-USDT")).findFirst().get();
        System.out.println(symbol);
        System.out.println(symbol.getBigDecimal("lotSz"));
        System.out.println(symbol.getBigDecimal("tickSz"));
