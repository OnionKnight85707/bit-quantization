...
public class SpotRequestImpl implements SpotRequestClient {

    private final RestApiRequestImpl requestImpl;

    SpotRequestImpl(RestApiRequestImpl requestImpl) {
    ...
    @Override
    public FeeInformation getFeeInformation(String symbol) {
        return RestApiInvoker.callSync(requestImpl.getFeeInformation(symbol));
    }
    ...
    @Override
    public Order postOrder(String symbol, OrderSide side, OrderType orderType, String quoteOrderQty, String quantity, String price, String newClientOrderId, NewOrderRespType newOrderRespType) {
        ...
        return RestApiInvoker.callSync(requestImpl.postOrder(symbol, side, orderType,
                timeInForce, quantity, quoteOrderQty, price, null,
                newClientOrderId, null, null, newOrderRespType));
    }
    ...
    public Order postOrder(String symbol, OrderSide side, OrderType orderType,
        ...
        return RestApiInvoker.callSync(requestImpl.postOrder(symbol, side, orderType,
                timeInForce, quantity, null, price, reduceOnly,
    ...
    @Override
    public JSONObject addIsolatedPositionMargin(String symbolName, int type, String amount) {
        return RestApiInvoker.callSync(requestImpl.addPositionMargin(symbolName, type, amount));
    }
