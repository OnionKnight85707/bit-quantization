...
import com.binance.client.spot.impl.utils.UrlParamsBuilder;
import com.binance.client.spot.model.ResponseResult;
import com.binance.client.spot.model.market.*;
import com.binance.client.spot.model.trade.*;
import com.binance.client.spot.model.enums.*;
...
class RestApiRequestImpl {
    ...
    RestApiRequestImpl(String apiKey, String secretKey, SpotRequestOptions options) {
        this.apiKey = apiKey;
    ...
    private Request createRequestByPut(String url, String address, UrlParamsBuilder builder) {
        return createRequest(url, address, builder.setMethod("PUT"));
    }
    ...
    RestApiRequest<FeeInformation> getFeeInformation(String symbol) {
        RestApiRequest<FeeInformation> request = new RestApiRequest<>();
        UrlParamsBuilder builder = UrlParamsBuilder.build();
        builder.putToUrl("symbol", symbol);
        request.request = createRequestByGetWithSignature("/sapi/v1/asset/tradeFee", builder);

        request.jsonParser = (jsonWrapper -> {
            System.out.println(jsonWrapper);
            JsonWrapperArray data = jsonWrapper.getJsonArray("data");
            FeeInformation result = new FeeInformation();
            data.forEach(item->{
                result.setSymbol(symbol);
                result.setMakerCommission(item.getBigDecimal("makerCommission"));
                result.setTakerCommission(item.getBigDecimal("takerCommission"));
            });
            return result;
        });
        return request;
    ...
    RestApiRequest<List<MarkPrice>> getMarkPrice(String symbol) {
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build()
                .putToUrl("symbol", symbol);
        request.request = createRequestByGet("/api/v3/premiumIndex", builder);
    ...
    RestApiRequest<List<FundingRate>> getFundingRate(String symbol, Long startTime, Long endTime, Integer limit) {
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build()
                ...
                .putToUrl("endTime", endTime)
                .putToUrl("limit", limit);
        request.request = createRequestByGet("/api/v3/fundingRate", builder);
    ...
    RestApiRequest<List<LiquidationOrder>> getLiquidationOrders(String symbol, Long startTime, Long endTime,
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build()
                ...
                .putToUrl("endTime", endTime)
                .putToUrl("limit", limit);
        request.request = createRequestByGetWithApikey("/api/v3/allForceOrders", builder);
    ...
    RestApiRequest<List<Object>> postBatchOrders(String batchOrders) {
        ...
        request.request = createRequestByPostWithSignature("/api/v3/batchOrders", builder);
        ...
        request.jsonParser = (jsonWrapper -> {
            ...
            jsonArray.forEach(obj -> {
                if (((JSONObject) obj).containsKey("code")) {
                    ...
                    o.setCummulativeQuoteQty(jsonObj.getBigDecimal("cummulativeQuoteQty"));
...
//                    o.setWorkingType(jsonObj.getString("workingType"));
    ...
    RestApiRequest<Order> postOrder(String symbol, OrderSide side, OrderType orderType,
            TimeInForce timeInForce, String quantity, String quoteOrderQty, String price, String reduceOnly,
...
//            result.setStopPrice(jsonWrapper.getBigDecimal("stopPrice"));
            ...
            result.setFills(new ArrayList<>());
            fills.forEach(e->{
                result.getFills().add(new Fill(e.getBigDecimal("price"), e.getBigDecimal("qty"), e.getBigDecimal("commission"), e.getString("commissionAsset")));
            });
...
//            result.setWorkingType(jsonWrapper.getString("workingType"));
    ...
    RestApiRequest<ResponseResult> changePositionSide(boolean dual) {
        ...
        request.request = createRequestByPostWithSignature("/api/v3/positionSide/dual", builder);
    ...
    RestApiRequest<ResponseResult> changeMarginType(String symbolName, String marginType) {
        ...
        request.request = createRequestByPostWithSignature("/api/v3/marginType", builder);
    ...
    RestApiRequest<JSONObject> addPositionMargin(String symbolName, int type, String amount) {
        RestApiRequest<JSONObject> request = new RestApiRequest<>();
        UrlParamsBuilder builder = UrlParamsBuilder.build()
                .putToUrl("symbol", symbolName)
                .putToUrl("amount", amount)
                .putToUrl("type", type);
        request.request = createRequestByPostWithSignature("/api/v3/positionMargin", builder);
    ...
    RestApiRequest<List<WalletDeltaLog>> getPositionMarginHistory(String symbolName, int type, long startTime, long endTime, int limit) {
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build()
                ...
                .putToUrl("endTime", endTime)
                .putToUrl("limit", limit);
        request.request = createRequestByGet("/api/v3/positionMargin/history", builder);
    ...
    RestApiRequest<JSONObject> getPositionSide() {
        RestApiRequest<JSONObject> request = new RestApiRequest<>();
        UrlParamsBuilder builder = UrlParamsBuilder.build();
        request.request = createRequestByGetWithSignature("/api/v3/positionSide/dual", builder);
...
//            result.setWorkingType(jsonWrapper.getString("workingType"));
    ...
    RestApiRequest<ResponseResult> cancelAllOpenOrder(String symbol) {
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build()
                .putToUrl("symbol", symbol);
        request.request = createRequestByDeleteWithSignature("/api/v3/allOpenOrders", builder);
    ...
    RestApiRequest<List<Object>> batchCancelOrders(String symbol, String orderIdList, String origClientOrderIdList) {
        ...
        request.request = createRequestByDeleteWithSignature("/api/v3/batchOrders", builder);
...
//                element.setWorkingType(item.getString("workingType"));
    ...
    RestApiRequest<List<AccountBalance>> getBalance() {
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build();
        request.request = createRequestByGetWithSignature("/api/v3/balance", builder);
    ...
    RestApiRequest<Leverage> changeInitialLeverage(String symbol, Integer leverage) {
        ...
        request.request = createRequestByPostWithSignature("/api/v3/leverage", builder);
    ...
    RestApiRequest<List<PositionRisk>> getPositionRisk() {
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build();
        request.request = createRequestByGetWithSignature("/api/v3/positionRisk", builder);
    ...
    RestApiRequest<List<MyTrade>> getAccountTrades(String symbol, Long startTime, Long endTime, 
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build()
                ...
                .putToUrl("fromId", fromId)
                .putToUrl("limit", limit);
        request.request = createRequestByGetWithSignature("/api/v3/userTrades", builder);
    ...
    RestApiRequest<List<Income>> getIncomeHistory(String symbol, IncomeType incomeType, Long startTime, Long endTime, 
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build()
                ...
                .putToUrl("endTime", endTime)
                .putToUrl("limit", limit);
        request.request = createRequestByGetWithSignature("/api/v3/income", builder);
    ...
    RestApiRequest<String> closeUserDataStream(String listenKey) {
        ...
        request.request = createRequestByDeleteWithSignature("/api/v3/userDataStream", builder);
