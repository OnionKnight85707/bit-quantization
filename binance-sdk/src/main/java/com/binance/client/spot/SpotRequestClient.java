...
import com.binance.client.spot.impl.BinanceApiInternalFactory;
 ...
 * {@link com.binance.client.spot.exception.BinanceApiException} will be thrown.
 */
public interface SpotRequestClient {
     ...
     */
    static SpotRequestClient create() {
        return create("", "", new SpotRequestOptions());
    }
     ...
     * @return The instance of synchronous client.
     */
    static SpotRequestClient create(String apiKey, String secretKey) {
        return BinanceApiInternalFactory.getInstance().createSyncRequestClient(apiKey, secretKey, new SpotRequestOptions());
    }
     ...
     * @return The instance of synchronous client.
     */
    static SpotRequestClient create(String apiKey, String secretKey, SpotRequestOptions options) {
     ...
     * @return Current exchange trading rules and symbol information.
     */
    FeeInformation getFeeInformation(String symbol);
    ...
    Order postOrder(String symbol, OrderSide side, OrderType orderType, String quoteOrderQty, String quantity, String price, String newClientOrderId, NewOrderRespType newOrderRespType);
    /**
     * Send in a new order.
     *
     * @return Order.
     ...
     * @return
     */
    JSONObject addIsolatedPositionMargin(String symbolName, int type, String amount);
