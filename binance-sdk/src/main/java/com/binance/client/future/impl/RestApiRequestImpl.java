...
import com.binance.client.future.impl.utils.UrlParamsBuilder;
...
class RestApiRequestImpl {
    ...
    RestApiRequestImpl(String apiKey, String secretKey, FutureRequestOptions options) {
        this.apiKey = apiKey;
    ...
    RestApiRequest<Order> postOrder(String symbol, OrderSide side, PositionSide positionSide, OrderType orderType,
       ...
       log.info(" binance order param: {}",builder.buildUrlToJsonString());
