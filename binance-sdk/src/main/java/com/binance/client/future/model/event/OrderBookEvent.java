package com.binance.client.future.model.event;
...
public class OrderBookEvent {
    ...
    public String toString() {
        return new ToStringBuilder(this, FutureBinanceApiConstants.TO_STRING_BUILDER_STYLE).append("eventType", eventType)
