...
import com.binance.client.future.impl.utils.JsonWrapperArray;

import com.binance.client.future.SubscriptionErrorHandler;
import com.binance.client.future.SubscriptionListener;
import com.binance.client.future.impl.utils.Channels;
import com.binance.client.future.model.enums.CandlestickInterval;
import com.binance.client.future.model.event.AggregateTradeEvent;
import com.binance.client.future.model.event.CandlestickEvent;
import com.binance.client.future.model.event.LiquidationOrderEvent;
import com.binance.client.future.model.event.MarkPriceEvent;
import com.binance.client.future.model.event.OrderBookEvent;
import com.binance.client.future.model.event.SymbolBookTickerEvent;
import com.binance.client.future.model.event.SymbolMiniTickerEvent;
import com.binance.client.future.model.event.SymbolTickerEvent;
import com.binance.client.future.model.market.OrderBookEntry;
import com.binance.client.future.model.user.AccountUpdate;
import com.binance.client.future.model.user.BalanceUpdate;
import com.binance.client.future.model.user.OrderUpdate;
import com.binance.client.future.model.user.PositionUpdate;
import com.binance.client.future.model.user.UserDataUpdateEvent;
        ...
        request.jsonParser = (jsonWrapper) -> {
            try {
                ...
                if(jsonWrapper.getString("e").equals("ACCOUNT_UPDATE")) {
                    ...
                    orderUpdate.setProfit(jsondata.getBigDecimal("rp"));
                    result.setOrderUpdate(orderUpdate);
                }
                return result;
            } catch (Exception e) {
                log.error("【Binance】解析返回值出现错误。返回值：{}", jsonWrapper);
                e.printStackTrace();
                return null;
            }
        };
