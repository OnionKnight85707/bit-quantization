package com.binance.client.future.model.market;
...
public class ExchangeFilter {
    ...
    public String toString() {
        return new ToStringBuilder(this, FutureBinanceApiConstants.TO_STRING_BUILDER_STYLE).append("filterType", filterType)
