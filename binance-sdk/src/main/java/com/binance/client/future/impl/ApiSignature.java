...
class ApiSignature {
    ...
    void createSignature(String accessKey, String secretKey, UrlParamsBuilder builder) {
        ...
        builder.putToUrl("recvWindow", Long.toString(FutureBinanceApiConstants.DEFAULT_RECEIVING_WINDOW))
                .putToUrl("timestamp", Long.toString(System.currentTimeMillis()-900));
