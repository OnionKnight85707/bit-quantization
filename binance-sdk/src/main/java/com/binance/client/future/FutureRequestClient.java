...
import com.binance.client.future.model.market.*;
 ...
 * {@link com.binance.client.future.exception.BinanceApiException} will be thrown.
 */
public interface FutureRequestClient {
     ...
     */
    static FutureRequestClient create() {
        return create("", "", new FutureRequestOptions());
    }
     ...
     * @return The instance of synchronous client.
     */
    static FutureRequestClient create(String apiKey, String secretKey) {
        return BinanceApiInternalFactory.getInstance().createSyncRequestClient(apiKey, secretKey, new FutureRequestOptions());
    }
     ...
     * @return The instance of synchronous client.
     */
    static FutureRequestClient create(String apiKey, String secretKey, FutureRequestOptions options) {
