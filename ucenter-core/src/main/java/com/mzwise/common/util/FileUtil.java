...
//        String name = Objects.requireNonNull(getFileNameNoEx(file.getOriginalFilename())).replaceAll(" ", "");
        ...
        try {
            ...
            log.info("上传文件路径path={}, absolutePath={}", dest.getPath(), dest.getAbsolutePath());
            // 文件写入
