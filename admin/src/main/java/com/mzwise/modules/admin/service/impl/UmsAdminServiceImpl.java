...
import com.mzwise.modules.admin.entity.*;
import com.mzwise.modules.admin.mapper.UmsAdminLoginLogMapper;
import com.mzwise.modules.admin.mapper.UmsAdminMapper;
import com.mzwise.modules.admin.mapper.UmsResourceMapper;
import com.mzwise.modules.admin.mapper.UmsRoleMapper;
...
import com.mzwise.modules.admin.service.UmsAdminRoleRelationService;
    ...
    public String login(String username, String password) {
        ...
        try {
            ...
            if (!passwordEncoder.matches(password, userDetails.getPassword())) {
                throw new ApiException("username_password_wrong");
            }
...
//            updateLoginTimeByUsername(username);
     ...
     */
    @Override
    public List<IdAndNameVo> adminList(String name) {
        return baseMapper.adminList(name);
    }
    ...
    @Override
    public int updatePassword(Long adminId, PasswordParam param) {
        UmsAdmin umsAdmin = getById(adminId);
        if (!passwordEncoder.matches(param.getOldPassword(), umsAdmin.getPassword())) {
            return -3;
        }
        umsAdmin.setPassword(passwordEncoder.encode(param.getNewPassword()));
